...
var pool = module.exports = function pool(options, authorizeFn) {
    ...
    function SubmitBlock(blockHex, callback) {
        ...
        _this.daemon.cmd(rpcCommand,
            ...
            function (results) {
                ...
                emitLog('\u001b[33mSubmitted Block using \u001b[37m' + rpcCommand + ' successfully to daemon instance(s)');
                callback();
            }
        );
    }
        ...
        _this.jobManager.on('newBlock', function (blockTemplate) {
            ...
            if (!isValidBlock)
                ...
                if (jobManagerLastSubmitBlockHex === blockHex) {
                    emitWarningLog('\u001b[33mWarning, ignored duplicate submit block \u001b[37m' + blockHex);
                } else {
                    ...
                    SubmitBlock(blockHex, function () {
                        CheckBlockAccepted(shareData.blockHash, function (isAccepted, tx) {
                            ...
                            GetBlockTemplate(function (error, result, foundNewBlock) {
                                if (foundNewBlock) {
                                    emitLog('\u001b[33mBlock notification via RPC after block submission\u001b[37m');
                                }
                            });
                        });
                    });
    ...
    function StartStratumServer(finishedCallback) {
        ...
        _this.stratumServer.on('started', function () {
            ...
            emitLog('\u001b[35mNo new blocks for \u001b[37m' + options.jobRebroadcastTimeout + '\u001b[35m seconds - updating transactions & rebroadcasting work\u001b[37m');
            ...
            client.on('difficultyChanged', function (diff) {
                ...
                emitLog('\u001b[32mUnknown stratum method from \u001b[37m' + client.getLabel() + ': ' + fullMessage.method);
    ...
    function SetupBlockPolling() {
        ...
        blockPollingIntervalId = setInterval(function () {
            GetBlockTemplate(function (error, result, foundNewBlock) {
                if (foundNewBlock)
                    emitLog('\u001b[35mBlock notification via RPC polling\u001b[37m');
            });
        }, pollingInterval);
    }
    ...
    this.processBlockNotify = function (blockHash, sourceTrigger) {
        emitLog('\u001b[35mBlock notification via \u001b[37m' + sourceTrigger);
