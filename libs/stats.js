...
//console.log(poolConfigs[coinName].coin.symbol.toUpperCase());
...
//	      price: price || 0,
//	      coinData: null || 0,  //  getData(poolConfigs[coinName].coin.symbol.toUpperCase()),
//	      marketStats: marketData || null,
...
/*
	     for(var h = replies[i + 12].length; h > 0; h--){
                  var jsonObj;
                  try {
                      jsonObj = JSON.parse(replies[i + 12][h-1]);
                  } catch(e) {
                      jsonObj = null;
                  }
                  if (jsonObj !== null) {
			console.log('jsonObj ',jsonObj);
                      coinStats.coinData.push(jsonObj);
                  }
              }
*/
...
//			blocksFound: null
	...
	portalStats.global.hashrate += coinStats.hashrate; // doug
	portalStats.tickerPrice = 2.09; // doug
